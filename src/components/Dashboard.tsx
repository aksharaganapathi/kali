  ...
  return (
    <div className="min-h-screen px-4 py-10 sm:px-8 max-w-6xl mx-auto">
      ...
      >
        ...
        {/* Brain Workout Card */}
        <div className="col-span-1 rounded-2xl border border-violet-500/25 bg-linear-to-br from-violet-600/15 to-purple-600/10 p-5 flex flex-col gap-3 justify-between">
