    ...
    <div className="w-full flex flex-col items-center">
      ...
      <motion.button
        ...
        className={`
          ...
          ${playing ? "bg-saffron/20 border-saffron/30" : "bg-white/5 hover:bg-white/10"}
        `}
      >
        <motion.svg
      ...
      <p className="text-xs text-sand-dim mb-8">Select the matching character</p>
        ...
        {exercise.options?.map((option) => {
          ...
          return (
            <GlassCard
              ...
              className={`
                p-5 text-center cursor-pointer select-none
