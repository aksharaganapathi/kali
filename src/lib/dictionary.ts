...
/**
 * Computes the minimum level needed to decode a word based on which
 * characters it requires. Virama presence implies conjuncts (L10).
 */
function recategorizeLevel(entry: RawWordEntry): LevelId {
  if (entry.kannada.includes("\u0CCD")) return 10;
  let maxRank = 0;
  for (const char of entry.requiredChars) {
...
const RAW_DICTIONARY: RawWordEntry[] = [
  ...
  { kannada: "ನೀನು", romanization: "neenu", meaning: "you (singular)", requiredChars: ["ನ", "ೀ", "ು"], minLevel: 3 },
  ...
  { kannada: "ನೀವು", romanization: "neevu", meaning: "you (plural)", requiredChars: ["ನ", "ೀ", "ವ", "ು"], minLevel: 4 },
  ...
  { kannada: "ಬರ", romanization: "bara", meaning: "famine / drought", requiredChars: ["ಬ", "ರ"], minLevel: 2 },
  ...
  { kannada: "ಬೆಳೆ", romanization: "bele", meaning: "crop / grow", requiredChars: ["ಬ", "ೆ", "ಳ", "ೆ"], minLevel: 4 },
  ...
  { kannada: "ಮಳೆ", romanization: "male", meaning: "rain", requiredChars: ["ಮ", "ಳ", "ೆ"], minLevel: 4 },
  { kannada: "ಬೆಳಕು", romanization: "belaku", meaning: "light", requiredChars: ["ಬ", "ೆ", "ಳ", "ಕ", "ು"], minLevel: 4 },
  { kannada: "ಕಣ್ಣು", romanization: "kannu", meaning: "eye", requiredChars: ["ಕ", "ಣ", "ು"], minLevel: 5 },
  ...
  { kannada: "ಗಾಳಿ", romanization: "gaali", meaning: "wind", requiredChars: ["ಗ", "ಾ", "ಳ", "ಿ"], minLevel: 4 },
  ...
  { kannada: "ಬೆಟ್ಟ", romanization: "betta", meaning: "hill", requiredChars: ["ಬ", "ೆ", "ಟ"], minLevel: 5 },
  ...
  { kannada: "ಮೇಜು", romanization: "meju", meaning: "table", requiredChars: ["ಮ", "ೇ", "ಜ", "ು"], minLevel: 3 },
  { kannada: "ಕುರಿ", romanization: "kuri", meaning: "sheep", requiredChars: ["ಕ", "ು", "ರ", "ಿ"], minLevel: 3 },
  { kannada: "ಬಟ್ಟೆ", romanization: "batte", meaning: "cloth", requiredChars: ["ಬ", "ಟ", "ೆ"], minLevel: 5 },
  { kannada: "ಕಿವಿ", romanization: "kivi", meaning: "ear", requiredChars: ["ಕ", "ಿ", "ವ", "ಿ"], minLevel: 3 },
  { kannada: "ಹಣ್ಣು", romanization: "hannu", meaning: "fruit", requiredChars: ["ಹ", "ಣ", "ು"], minLevel: 5 },
  { kannada: "ಬಾಳೆ", romanization: "baale", meaning: "banana", requiredChars: ["ಬ", "ಾ", "ಳ", "ೆ"], minLevel: 4 },
  ...
  { kannada: "ಬಿಳಿ", romanization: "bili", meaning: "white", requiredChars: ["ಬ", "ಿ", "ಳ", "ಿ"], minLevel: 4 },
  ...
  { kannada: "ಬೆಳಗು", romanization: "belagu", meaning: "morning", requiredChars: ["ಬ", "ೆ", "ಳ", "ಗ", "ು"], minLevel: 4 },
  ...
  { kannada: "ಮಗಳು", romanization: "magalu", meaning: "daughter", requiredChars: ["ಮ", "ಗ", "ಳ", "ು"], minLevel: 4 },
  ...
  { kannada: "ಅಣ್ಣ", romanization: "anna", meaning: "elder brother", requiredChars: ["ಅ", "ಣ"], minLevel: 5 },
  ...
  { kannada: "ಸೇಬು", romanization: "sebu", meaning: "apple", requiredChars: ["ಸ", "ೇ", "ಬ", "ು"], minLevel: 3 },
  ...
  { kannada: "ಹಳೆ", romanization: "hale", meaning: "old", requiredChars: ["ಹ", "ಳ", "ೆ"], minLevel: 4 },
  { kannada: "ದೊಡ್ಡ", romanization: "dodda", meaning: "big", requiredChars: ["ದ", "ೊ", "ಡ"], minLevel: 5 },
  { kannada: "ಸಣ್ಣ", romanization: "sanna", meaning: "small", requiredChars: ["ಸ", "ಣ"], minLevel: 5 },
  { kannada: "ಉದ್ದ", romanization: "udda", meaning: "long", requiredChars: ["ಉ", "ದ"], minLevel: 5 },
  { kannada: "ಗಟ್ಟಿ", romanization: "gatti", meaning: "hard / strong", requiredChars: ["ಗ", "ಟ", "ಿ"], minLevel: 5 },
  { kannada: "ಮೃದು", romanization: "mrudu", meaning: "soft", requiredChars: ["ಮ", "ೃ", "ದ", "ು"], minLevel: 3 },
  { kannada: "ಒಳ್ಳೆ", romanization: "olle", meaning: "good", requiredChars: ["ಒ", "ಳ", "ೆ"], minLevel: 5 },
  { kannada: "ಕೆಟ್ಟ", romanization: "ketta", meaning: "bad", requiredChars: ["ಕ", "ೆ", "ಟ"], minLevel: 5 },
  { kannada: "ನೋಡು", romanization: "noodu", meaning: "see / look", requiredChars: ["ನ", "ೋ", "ಡ", "ು"], minLevel: 4 },
  { kannada: "ಕೇಳು", romanization: "kaelu", meaning: "listen / ask", requiredChars: ["ಕ", "ೇ", "ಳ", "ು"], minLevel: 4 },
  { kannada: "ಹೇಳು", romanization: "haelu", meaning: "tell / say", requiredChars: ["ಹ", "ೇ", "ಳ", "ು"], minLevel: 4 },
  ...
  { kannada: "ತೊಳೆ", romanization: "tole", meaning: "wash", requiredChars: ["ತ", "ೊ", "ಳ", "ೆ"], minLevel: 4 },
  ...
  { kannada: "ಕೊಳ", romanization: "kola", meaning: "pond", requiredChars: ["ಕ", "ೊ", "ಳ"], minLevel: 4 },
  { kannada: "ಅಡುಗೆ", romanization: "aduge", meaning: "cooking", requiredChars: ["ಅ", "ಡ", "ು", "ಗ", "ೆ"], minLevel: 4 },
  ...
  { kannada: "ಬೇಳೆ", romanization: "baele", meaning: "lentil", requiredChars: ["ಬ", "ೇ", "ಳ", "ೆ"], minLevel: 4 },
  { kannada: "ತರಕಾರಿ", romanization: "tarakaari", meaning: "vegetable", requiredChars: ["ತ", "ರ", "ಕ", "ಾ", "ಿ"], minLevel: 3 },
  { kannada: "ಹಿಟ್ಟು", romanization: "hittu", meaning: "flour", requiredChars: ["ಹ", "ಿ", "ಟ", "ು"], minLevel: 5 },
  ...
  { kannada: "ಕರ್ನಾಟಕ", romanization: "karnaaTaka", meaning: "Karnataka", requiredChars: ["ಕ", "ರ", "ನ", "ಾ", "ಟ"], minLevel: 5 },
  ...
  { kannada: "ನಮಸ್ಕಾರ", romanization: "namaskaara", meaning: "greeting / hello", requiredChars: ["ನ", "ಮ", "ಸ", "ಕ", "ಾ", "ರ"], minLevel: 5 },
  { kannada: "ಧನ್ಯವಾದ", romanization: "dhanyavaada", meaning: "thank you", requiredChars: ["ಧ", "ನ", "ಯ", "ವ", "ಾ", "ದ"], minLevel: 5 },
  { kannada: "ಹೌದು", romanization: "haudu", meaning: "yes", requiredChars: ["ಹ", "ೌ", "ದ", "ು"], minLevel: 3 },
  { kannada: "ಇಲ್ಲ", romanization: "illa", meaning: "no / not", requiredChars: ["ಇ", "ಲ"], minLevel: 5 },
  ...
  { kannada: "ಎಲ್ಲಿ", romanization: "elli", meaning: "where", requiredChars: ["ಎ", "ಲ", "ಿ"], minLevel: 5 },
  { kannada: "ಹೊಟ್ಟೆ", romanization: "hoTTe", meaning: "stomach", requiredChars: ["ಹ", "ೊ", "ಟ", "ೆ"], minLevel: 5 },
  ...
  { kannada: "ಸಮುದ್ರ", romanization: "samudra", meaning: "ocean", requiredChars: ["ಸ", "ಮ", "ು", "ದ", "ರ"], minLevel: 5 },
  { kannada: "ಪರ್ವತ", romanization: "parvata", meaning: "mountain", requiredChars: ["ಪ", "ರ", "ವ", "ತ"], minLevel: 5 },
  ...
  { kannada: "ನಕ್ಷತ್ರ", romanization: "nakshatra", meaning: "star", requiredChars: ["ನ", "ಕ", "ಷ", "ತ", "ರ"], minLevel: 5 },
  { kannada: "ಮಕ್ಕಳು", romanization: "makkalu", meaning: "children", requiredChars: ["ಮ", "ಕ", "ಳ", "ು"], minLevel: 5 },
  ...
  { kannada: "ಚಿತ್ರ", romanization: "chitra", meaning: "picture", requiredChars: ["ಚ", "ಿ", "ತ", "ರ"], minLevel: 5 },
  ...
  { kannada: "ಬಣ್ಣ", romanization: "banna", meaning: "colour", requiredChars: ["ಬ", "ಣ"], minLevel: 5 },
  { kannada: "ರೂಪ", romanization: "ruupa", meaning: "form / beauty", requiredChars: ["ರ", "ೂ", "ಪ"], minLevel: 3 },
  { kannada: "ಶಕ್ತಿ", romanization: "shakti", meaning: "power", requiredChars: ["ಶ", "ಕ", "ತ", "ಿ"], minLevel: 5 },
  { kannada: "ಬುದ್ಧಿ", romanization: "buddhi", meaning: "intelligence", requiredChars: ["ಬ", "ು", "ದ", "ಿ"], minLevel: 5 },
  ...
  { kannada: "ಯಶಸ್ಸು", romanization: "yashassu", meaning: "success", requiredChars: ["ಯ", "ಶ", "ಸ", "ು"], minLevel: 5 },
];
...
function hasRestrictedGlyphsForLevel(word: string, currentLevel: LevelId): boolean {
  // Virama (conjuncts) gated until L10
  if (levelRank(currentLevel) < levelRank(10) && word.includes(VIRAMA)) return true;
  // Anusvara/Visarga gated until L6
  if (
