...
const retroflexAspirated: Character[] = [
  ...
  { glyph: "ಳ", romanization: "La", aliases: ["la", "ḷa"], type: "consonant", audioLabel: "ಳ" },
  ...
  { glyph: "ಛ", romanization: "chha", aliases: ["cha", "ca"], type: "consonant", audioLabel: "ಛ" },
  { glyph: "ಝ", romanization: "jha", aliases: ["jha"], type: "consonant", audioLabel: "ಝ" },
  { glyph: "ಥ", romanization: "Tha", aliases: ["tha", "thha"], type: "consonant", audioLabel: "ಥ" },
...
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    kannadaName: "ವಿಶೇಷ ವ್ಯಂಜನಗಳು",
    description: "Retroflex, aspirated, and sibilant consonants — the sounds that give Kannada its distinctive feel.",
